...
elem <- left_join(teach, grad, by = c("ncessch", "year", "leaid")) %>% 
  left_join(mca, by = c("ncessch", "year", "leaid")) %>%
  filter(
    level=="Elementary/Primary",  
    member>=50, 
    year %in% c(2003, 2011, 2021),
...
middl <- left_join(teach, grad, by = c("ncessch", "year", "leaid")) %>% 
  left_join(mca, by = c("ncessch", "year", "leaid")) %>%
  filter(
    level=="Middle", 
    member>=50, 
...
high <- left_join(teach, grad, by = c("ncessch", "year", "leaid")) %>% 
  left_join(mca, by = c("ncessch", "year", "leaid")) %>%
  filter(
